...
import EstadisticasDestacadas from "@/components/estadisticas-destacadas"
      ...
      <div className="container py-12">
        ...
        <div className="mb-12">
          <Card className="bg-white">
            <CardHeader>
              <CardTitle className="text-2xl text-sky-700">Nuestras Estadísticas</CardTitle>
              <CardDescription>Información relevante sobre nuestros servicios</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <CardContent>
                ...
                <div className="mt-4">
                  ...
                  <p className="text-gray-600 mt-2">
                    Estamos ubicados en la 2 av. 5-08 zona 3 de San Juan Sacatepéquez, a pocas cuadras del parque
                    central. Contamos con estacionamiento para pacientes.
                  </p>
                  <div className="mt-3">
                    <a
